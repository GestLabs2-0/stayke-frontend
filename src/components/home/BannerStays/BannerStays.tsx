...
const CONTENT = (
  <>
    ...
    <button
      type="button"
      className="mt-6 inline-flex items-center rounded-full bg-[#3B007F] w-full justify-center lg:w-auto md:justify-start px-6 py-3 text-sm lg:px-8 lg:py-4 lg:text-base font-semibold text-white transition-colors hover:bg-purple-700 cursor-pointer"
    >
