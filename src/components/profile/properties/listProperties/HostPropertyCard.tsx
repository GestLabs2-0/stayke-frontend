...
export function HostPropertyCard({
  ...
  const reviewLabel = `${property.reviews} ${
    property.reviews === 1 ? "reseña" : "reseñas"
  }`;
  const bookingLabel = `${property.bookingsCompleted} ${
    property.bookingsCompleted === 1 ? "reserva" : "reservas"
  }`;
