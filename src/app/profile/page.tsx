          ...
          <div className="px-6 pb-6">
            <div className="flex items-end justify-between -mt-10 mb-4">
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <button className="inline-flex items-center gap-1.5 rounded-xl border border-border px-3 py-1.5 text-xs text-muted-foreground hover:text-red-400 hover:border-red-400/50 transition-colors cursor-pointer">
